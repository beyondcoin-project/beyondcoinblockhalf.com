...
<body>
	<div class="container">
		...
		<table class="table table-striped">
			...
			<tr><td><b>Beyondcoin price (BTC):</b></td><td align = "right">$<?=number_format($price, 2);?></td></tr>
			<tr><td><b>Market capitalization (BTC):</b></td><td align = "right">$<?=number_format($coins * $price, 2);?></td></tr>
			...
			<tr><td><b>Beyondcoin inflation per day (BTC):</b></td><td align = "right">$<?=number_format($blocksPerDay * $blockReward * $price);?></td></tr>
			<tr><td><b>Beyondcoin inflation until next blockhalf event: (BTC):</b></td><td align = "right">$<?=number_format($coinsRemaining * $price);?></td></tr>
			...
			<tr><td><b>Hash rate:</b></td><td align = "right"><?=number_format($beyondcoin->getnetworkhashps() / 1000 / 1000 / 1000 / 1000) . 'TH/s';?></td></tr>
		</table>
		<!--<div style="text-align:center">
